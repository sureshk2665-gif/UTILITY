    ...
    <footer className="bg-secondary mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-white font-semibold text-sm mb-3">Organize PDF</h3>
            <ul className="space-y-1.5">
              {toolsByCategory.organize.map((t) => (
                <li key={t.slug}>
                  <Link href={t.available ? `/${t.slug}` : "#"} className="text-sm text-white/55 hover:text-white transition-colors">
                    {t.name}
                  </Link>
                </li>
              ))}
          ...
          <div>
            <h3 className="text-white font-semibold text-sm mb-3">Convert PDF</h3>
            <ul className="space-y-1.5">
          ...
          <div>
            <h3 className="text-white font-semibold text-sm mb-3">Edit PDF</h3>
            <ul className="space-y-1.5">
          ...
          <div>
            <h3 className="text-white font-semibold text-sm mb-3">More Tools</h3>
            <ul className="space-y-1.5">
