...
export const tools: Tool[] = [
  ...
  { name: "Page Numbers", slug: "page-numbers", description: "Add page numbers to your PDF with custom position.", category: "organize", color: "#E74C3C", icon: "numbers", available: false },

  // Convert to PDF
  { name: "JPG to PDF", slug: "jpg-to-pdf", description: "Convert JPG images to PDF in seconds.", category: "convert", color: "#3498DB", icon: "image", available: false },
  { name: "Word to PDF", slug: "word-to-pdf", description: "Convert DOC and DOCX files to PDF.", category: "convert", color: "#3498DB", icon: "word", available: false },
  { name: "PowerPoint to PDF", slug: "ppt-to-pdf", description: "Convert PPT and PPTX slides to PDF.", category: "convert", color: "#3498DB", icon: "ppt", available: false },
  { name: "Excel to PDF", slug: "excel-to-pdf", description: "Convert XLSX spreadsheets to PDF.", category: "convert", color: "#3498DB", icon: "excel", available: false },
  { name: "HTML to PDF", slug: "html-to-pdf", description: "Convert webpages to PDF by URL.", category: "convert", color: "#3498DB", icon: "html", available: false },

  // Convert from PDF
  { name: "PDF to JPG", slug: "pdf-to-jpg", description: "Convert each PDF page into a JPG image.", category: "convert", color: "#3498DB", icon: "image", available: false },
  { name: "PDF to Word", slug: "pdf-to-word", description: "Convert PDF to editable DOCX documents.", category: "convert", color: "#3498DB", icon: "word", available: false },
  { name: "PDF to PowerPoint", slug: "pdf-to-ppt", description: "Turn your PDF into a PPTX slideshow.", category: "convert", color: "#3498DB", icon: "ppt", available: false },
  { name: "PDF to Excel", slug: "pdf-to-excel", description: "Extract PDF tables into XLSX spreadsheets.", category: "convert", color: "#3498DB", icon: "excel", available: false },
  ...
  // Edit PDF
  { name: "Edit PDF", slug: "edit-pdf", description: "Add text, images, shapes, and annotations.", category: "edit", color: "#27AE60", icon: "edit", available: false },
  { name: "Rotate PDF", slug: "rotate-pdf-edit", description: "Rotate pages by 90°, 180°, or 270°.", category: "edit", color: "#27AE60", icon: "rotate", available: false },
  ...
  { name: "Watermark", slug: "watermark", description: "Stamp text or image watermarks on pages.", category: "edit", color: "#27AE60", icon: "watermark", available: false },
  ...
  { name: "Crop PDF", slug: "crop-pdf", description: "Adjust margins and crop page areas.", category: "edit", color: "#27AE60", icon: "crop", available: false },
